...
namespace JMImoveisAPI.Controllers
{
    ...
    public class TipoPagamentoController : ControllerBase
    {
        ...
        public TipoPagamentoController(ITipoPagamentoRepository repository) => _repository = repository;
        ...
        [HttpPost]
        public async Task<IActionResult> Create(TipoPagamento item)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update(TipoPagamento item)
        {
