...
namespace JMImoveisAPI.Controllers
{
    ...
    public class ParcelasController : ControllerBase
    {
        ...
        public ParcelasController(IParcelasRepository repository) => _repository = repository;
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Parcelas item)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update(Parcelas item)
        {
